...
class _ProgressScreenState extends State<ProgressScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            steps(
                stepNumber: 1,
                text: "Schedule first chat with science",
                completed: true),
            steps(stepNumber: 2, text: "Chat with science", completed: true),
            steps(stepNumber: 3, text: "Receive your first set of discomforts"),
          ],
        ),
      ),
    );
  ...
  Widget steps(
      {required int stepNumber, required String text, bool completed = false}) {
    return Container(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                shape: BoxShape.circle,
                border:
                    Border.all(color: completed ? success : next, width: 2)),
            child: Center(
              child: completed
                  ? SvgPicture.asset(
                  ...
                  : Container(
                      ...
                      height: 13,
                      decoration:
                          BoxDecoration(shape: BoxShape.circle, color: next),
                    ),
            ),
          ),
          SizedBox(width: 16),
